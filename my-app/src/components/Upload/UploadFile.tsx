    ...
    return (
        <div>
            <div className='flex items-center justify-center w-full'>
                ...
                className="flex flex-col items-center justify-center w-96 h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-white hover:bg-gray-100 dark:border-gray-200 dark:hover:border-gray-400 dark:hover:bg-gray-100">
                    <div className='flex flex-col items-center justify-center pt-5 pb-6'>
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400">WAV, MP4, MP3, WEBM, AVI</p>
                    </div>
                    <input 
            ...
            <div className="w-max mt-5 ml-5 max-w-full overflow-hidden whitespace-nowrap">
                <p className="text-gray-300">{previousApiResponse}</p>
                {previousApiResponse && <p className="animate-typing text-gray-600">. . / / . / / </p>}
                <p key={animationKey} className="animate-typing overflow-hidden whitespace-nowrap border-r-2 border-r-gray-600 pr-5 text-1xl text-gray-600 font-bold" style={{ whiteSpace: 'pre-wrap' }}>
                    {currentApiResponse}
                </p>
            </div>
